    ...
    return {
        ...
        async fetchCounts() {
            try {
                ...
                document.getElementById('employee-count').textContent = data.numEmployees;
                document.getElementById('manager-count').textContent = data.numManagers;
                document.getElementById('material-count').textContent = data.totalMaterials;

                this.updatePercentageDisplay('employee', data.employeeChange);
                this.updatePercentageDisplay('manager', data.managerChange);
                this.updatePercentageDisplay('total-material', data.totalMaterialsChange);
                ...
                const checkChartLoaded = setInterval(() => {
                    ...
                    if (ctx) {
                        ...
                        this.createMaterialChart(data.numEmployees, data.numManagers, data.totalMaterials);
                    }
                }, 100);
